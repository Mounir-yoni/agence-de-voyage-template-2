        ...
        >
            <div className="container px-8 mx-auto">
                <motion.div
                    ...
                    transition={{ duration: 0.5, delay: 0.2 }}
                >
                    <h2 className="text-3xl md:text-4xl font-bold text-center mb-8" style={{ color: '#262626' }}>Special Offers 🌟</h2>
                </motion.div>
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                >
                                                    <Link
                                                        ...
                                                        className=" hover:text-orange-500 text-sm font-semibold flex items-center gap-2"
                                                        prefetch={true}
                                                        style={{ color: '#262626' }}
                                                    >
